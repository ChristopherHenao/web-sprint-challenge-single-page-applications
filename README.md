...
-useRouteMatch attempts to match the current url in the same way Route does. It's mostly useful for getting access to the match data without rendering a route.

1. How would you explain form validation to someone who has never programmed before?

-Validation is the restricting of what can be input in different inputs through your page.

1. In 1-2 sentences, define end to end testing.

-End to end testing, or E2E testing is the automated testing of an application or webpage from the initial interaction through the whole page or program.
